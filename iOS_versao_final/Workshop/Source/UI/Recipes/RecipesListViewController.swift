...
class RecipesListViewController: UIViewController {
  ...
  private let recipesCollectionView: UICollectionView = UICollectionView(
    frame: .zero,
    collectionViewLayout: UICollectionViewFlowLayout.makeLayout(minimumLineSpacing: 16)
  )
  ...
  private func setupLayout() {
    ...
    recipesCollectionView.makeEdgesEqualTo(self, insets: UIEdgeInsets(all: 16))
  }
...
extension RecipesListViewController: UICollectionViewDataSource {
  ...
  func collectionView(
    ...
    cell.setRecipe(filteredRecipes[indexPath.item])
